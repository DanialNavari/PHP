...
<?php
require_once('db.php');
$q = "SELECT * FROM catalog WHERE 1";
$result = mysqli_query($conn, $q);
$row = mysqli_fetch_assoc($result);
$all = $row['all'];
$all +=0.5;

$qq = "UPDATE catalog SET `all` = ".$all." WHERE id=1";
...
<head>
    ...
    <link rel="stylesheet/less" type="text/css"
        href="./less/product.less?v=Xko7ePekQEnwU4pJzf4il86jOuE8Rq1KMjVS-EeSgHc">
...
/* =================================== */
    ...
    <link rel="stylesheet/less" type="text/css"
        href="./less/general.less?v=9zhnfTBp5vE8BxJrrIJJSPYpBDoGa0bdrywImv_QiK0">
...
<body id="body">
    ...
    <header id="header" class="" style="background: #01815f;">
        ...
        <div id="div-parent-container-navigation">
            ...
            <button class="navbar-toggler navbar-toggler-right navbar-icon outline-none d-lg-none d-block" type="button"
            ...
            <div class="container position-relative container-nav" style="background:#01815f;color:#fff">
                    ...
                    <div class="position-relative">
                        ...
                        <ul id="nav" class="ul-navigation d-lg-flex d-none">
                            ...
                            <li id="nav-product" class="nav-item">
                                <a id="a-product-navigation" class="nav-link no-select">برند ها</a>
                                <div class="underline-nav-item"></div>
                                    ...
                                    <div id="row-product-navigation" class="row row-product-navigation">
                                        ...
                                        <div class="col-item-product-navigation">
                                            <a class="external" href="./product.php?cat=Barjio">
                                                <div class="item-product-navigation">
                                                    <img src="./img/product_nav/creed.png">
                                                    <h1>Barjio</h1>
                                                </div>
                                            </a>
                                        </div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link external" href="https://perfumeara.com/mag/" target="_blank">بلاگ</a>
                                <div class="underline-nav-item"></div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link external" href="https://perfumeara.com/expo/"
                                    target="_blank">گالری</a>
                                <div class="underline-nav-item"></div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                                    aria-haspopup="true" aria-expanded="false">بهار آرا</a>
                                <div class="underline-nav-item d-lg-block d-none"></div>
                                <div class="dropdown-menu custom-dropdown">
                                    <a class="a_RedirectPersonel dropdown-item external"
                                        href="https://perfumeara.com/about/" target="_blank">درباره ما</a>
                                    <a class="a_RedirectPersonel dropdown-item external"
                                        href="https://perfumeara.com/contact/" target="_blank">تماس با ما</a>
                                    <a class="a_RedirectPersonel dropdown-item external"
                                        href="https://perfumeara.com/employment/" target="_blank">استخدام</a>
                                    <a class="a_RedirectPersonel dropdown-item external"
                                        href="https://perfumeara.com/Complaints/" target="_blank">شکایات و پیشنهادات</a>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link external" href="https://zarinp.al/perfumeara.com"
                                    target="_blank">تسویه حساب</a>
                                <div class="underline-nav-item"></div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                                    aria-haspopup="true" aria-expanded="false">خدمات الکترونیک</a>
                                <div class="underline-nav-item d-lg-block d-none"></div>
                                <div class="dropdown-menu custom-dropdown">
                                    <a class="a_RedirectPersonel dropdown-item external" href="emp"
                                        target="_blank">پرسنل</a>
                                </div>
                            </li>
                    ...
                    <div class="div-navigation-mobile" style="text-align:center">
                        ...
                        <div class="div-parent-ul-navigation-mobile">
                            ...
                            <ul>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link external" href="https://perfumeara.com/mag/"
                                        target="_blank">بلاگ</a>
                                    <div class="underline-nav-item"></div>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link external" href="https://perfumeara.com/expo/"
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu custom-dropdown">
                                        ...
                                        <a class="a_RedirectPersonel dropdown-item external"
                                            href="https://perfumeara.com/employment/" target="_blank">استخدام</a>
                                        <a class="a_RedirectPersonel dropdown-item external"
                                            href="https://perfumeara.com/Complaints/" target="_blank">شکایات و
                                            پیشنهادات</a>
                                    </div>
                                </li>
    ...
    <main id="main">
        ...
        <main id="main">
            ...
            <section id="section-header-product-details" style="background-color: #151216;">
                ...
                <div class="container container-content-header">
                    <div class="row m-0">
                        ...
                        <div class="col-12 div-col-title-white" style="z-index:2">
                            <h1 class="m-0"
                                style="text-align: center; font-family: IS-M; color: #fff; font-size: 24px; line-height: 55px; text-shadow: 2px 2px 4px #000000;">
                                دانلود کاتالوگ ها</h1>
                        </div>
            ...
            <section id="section-product-details" style="margin-bottom:2rem">
                ...
                <div class="row">
                        <div >
                            <table>
                                <tr>
                                    <td>
                                        <img src="./img/pdf.png" alt="pdf" class="pdf" style="width: 60px;margin-bottom: 4rem;">
                                    </td>
                                    <td>
                                        <a href="https://baharara.com/perfumeara_catalog.pdf">
                                            <h3>دانلود کاتالوگ پرفیوم آرا</h3>
                                        </a>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div >
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <a href="https://baharara.com/tapputi_catalog.pdf">
                                            <h3>دانلود کاتالوگ تاپوتی</h3>
                                        </a>
                                    </td>
                                </tr>
                            </table>
        ...
        <footer id="footer" class="wow  fadeIn slow animated" data-wow-delay="0.1s"
                ...
                <div class="row row-content-footer">
                    ...
                    <div class="col-12 col-md-4 div-item-content-footer">
                        ...
                        <div class="div-content-footer">
                            <p>
                                ...
                                <a href="mailto:info@baharara.com"><i class="fa fa-circle"
                                        style="font-size: 3px;"></i></a>
                    ...
                    <div class="col-12 col-md-4 div-item-content-footer">
                        ...
                        <div class="div-content-footer">
                            <!--<h3>تلفن</h3>-->
                            <p>
                                تلفن : <a href="tel:05138768445">05138768445</a>

                            </p>
                            <p>
                                <img referrerpolicy='origin' id='rgvjwlaoapfufukznbqejzpe' style='cursor:pointer'
                                    onclick='window.open("https://logo.samandehi.ir/Verify.aspx?id=345627&p=xlaoaodsdshwgvkauiwkjyoe", "Popup","toolbar=no, scrollbars=no, location=no, statusbar=no, menubar=no, resizable=0, width=450, height=630, top=30");width: 50px; margin: 0.1rem 0 0 0;'
                                    alt='logo-samandehi'
                                    src='https://logo.samandehi.ir/logo.aspx?id=345627&p=qftishwlujynwlbqodrfyndt' />
                            </p>
                        </div>
            ...
            <div class="site-info-footer" style="direction: ltr;background-color: #037a5b;color: #e5e2e2;">
                <span>
                    ©Copyright 2021 All right reserved. <a style="text-decoration:underline;color:unset;"
                        target="_blank" href="https://baharara.com/">Bahar Ara</a>
                </span>
            </div>
        ...
        <div class="magnifier"
            style="position: absolute; z-index: 0; width: 308px; height: 435.844px; left: -10000px; top: -10000px; visibility: hidden; overflow: hidden; border: 1px solid black;">
        </div>
        <div class="cursorshade"
            style="z-index: 0; display: none; position: absolute; width: 154px; height: 218px; top: 0px; left: 0px; border: 1px solid black; opacity: 0.3; background-color: rgb(255, 255, 255);">
        </div>
