                ...
                <nav id="navigation">
                    ...
                    <div class="position-relative">
                        ...
                        <ul id="nav" class="ul-navigation d-lg-flex d-none">
                            ...
                            <li class="nav-item">
                                <a class="nav-link external" href="https://perfumeara.com/mag/">بلاگ</a>
                                <div class="underline-nav-item"></div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link external" href="https://perfumeara.com/about/">درباره ما</a>
                                <div class="underline-nav-item"></div>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link external" href="https://perfumeara.com/contact/">تماس با ما</a>
                                <div class="underline-nav-item"></div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link external" href="https://zarinp.al/perfumeara.com">تسویه حساب</a>
                                <div class="underline-nav-item"></div>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu custom-dropdown">
                                    <a class="a_RedirectPersonel dropdown-item external" href="#"
                                        target="_blank">پرسنل</a>
                                    <a class="a_RedirectCustomer dropdown-item external" href="#"
                                        target="_blank">مشتریان</a>
                                    <a class="a_Recruitment dropdown-item external"
                                        href="https://perfumeara.com/franchize/" target="_blank">استخدام</a>
                                    <a class="dropdown-item external" href="https://perfumeara.com/Complaints/"
                                        target="_blank">شکایات و پیشنهادات</a>
                                </div>
                            </li>
                    ...
                    <div class="div-navigation-mobile" style="text-align: center;">
                        ...
                        <div class="div-parent-ul-navigation-mobile">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a class="external" href="https://perfumeara.com/mag">بلاگ</a>
                                </li>
                                <li>
                                    <a class="external" href="https://perfumeara.com/about">درباره ما</a>
                                </li>
                                <li>
                                    <a class="external" href="https://perfumeara.com/contact">تماس با ما</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link external" href="https://zarinp.al/perfumeara.com">تسویه حساب</a>
                                    <div class="underline-nav-item"></div>
        ...
        <!--         <div class="container-logo container position-relative">
            <a href="/">
                <div class="div-parent-shape-logo-navigation">
                    ...
                    <img class="img-logo-navigation" src="./img/logo_behara_nav.png"
