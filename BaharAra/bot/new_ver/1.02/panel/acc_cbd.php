                                ...
                                <h3 class="font-24 mb-1">گزارش روزانه مسیر :
                                            ...
                                            <tr>
                                                ...
                                                for ($i = 0; $i < $count; $i++) {
                                                    ...
                                                    if ($check_is_factor > 0) {
                                                        $factor_link = "<a href='factor.php?f=" . $f_id . "&d=" . $tarikh . "'>" . $f_id . "</a>";
                                                    } else {
                                                        $factor_link = "-";
                                                    }
                                    ...
                                    <div class=" row" style="width: max-content; margin: 0 auto;">
                                        <form method="get" action="cbd.php" class="print">
                                            ...
                                            <button><a href="https://perfumeara.com/webapp/app/panel/visitors.php?g=<?php echo $_GET['g']; ?>" class="btn btn-danger">بازگشت</a></button>
