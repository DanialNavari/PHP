...
<?php
$site_admin = 'https://perfumeara.com/wp-admin';
$site_order = 'https://baharara.com/emp/dailyorder.php?date=' . date('Y-m-d');
$insta_order = 'https://barjio.com/order.php?date=' . date('Y-m-d');
$cbd = 'https://perfumeara.com/webapp/app1/panel/visitors.php?g=cfcd208495d565ef66e7dff9f98764da';
?>
<script>
    function open_web(x) {
        var today = new Date();
        ...
        if (x == 1) {
            y = 'https://perfumeara.com/wp-admin';
        } else if (x == 2) {
            y = 'https://baharara.com/emp/dailyorder.php?date=' + today;

        } else if (x == 3) {
            y = 'https://barjio.com/order.php?date=' + today;
        } else if (x == 4) {
            y = 'https://perfumeara.com/webapp/app1/panel/visitors.php?g=cfcd208495d565ef66e7dff9f98764da';
        } else if (x == 5) {
            y = 'https://perfumeara.com/webapp/app1/panel/all_factors.php?date=' + today;
        }
...
<body style="background-color: #2c2c2c;">
    <div class="header">
        <div class="item">
            <div class="sep">
                <fieldset>
                    <legend>سامانه های ثبت سفارشات</legend>
            ...
            <fieldset>
                ...
                <div class="sep">
                    <div class="items" onclick="open_web(4)">
                        ...
                        <div class="item-title">گزارش عملکرد بازاریاب ها(CBD)</div>
                    </div>
                    ...
                    <div class="items" onclick="open_web(5)">
                        ...
                        <div class="item-title">فاکتور های روزانه بازاریاب ها</div>
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset>
                <legend>مالی</legend>
                <div class="sep">
                    <div class="items" onclick="open_web(6)">
                        <div class="item_logo">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                                <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z" />
                            </svg>
                        </div>
                        <div class="item-title">فرم هزینه های جاری</div>
                    </div>
                </div>

                <div class="sep">
                    <div class="items" onclick="open_web(7)">
                        <div class="item_logo">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                                <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z" />
                            </svg>
                        </div>
                        <div class="item-title">مساعده</div>
                    </div>
                </div>
                ...
                <div class="sep">
                    <div class="items" onclick="open_web(7)">
                        ...
                        <div class="item-title">مرخصی</div>
                    </div>
                </div>
            </fieldset>
