...
<body class="login-area">
    ...
    ******* Page Wrapper Area Start **********
    ...
    switch ($_GET['g']) {
        case 'cfcd208495d565ef66e7dff9f98764da':
            $head = 'نواری';
            $g = 0;
            $sql_manager = "SELECT * FROM `customers` WHERE `rule` = 1 ORDER BY `id` ASC";
            break;
    ...
    ********* Page Wrapper Area End ***********
    ...
    <script src="http://baharara.com/emp/js/popper.min.js"></script>
    <script src="http://baharara.com/emp/js/bootstrap.min.js"></script>
    <script src="http://baharara.com/emp/js/bundle.js"></script>
    <script src="http://baharara.com/emp/js/user_login.js"></script>
    <!-- Active JS -->
    <script src="http://baharara.com/emp/js/default-assets/active.js"></script>
