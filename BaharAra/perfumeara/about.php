...
<head>
    ...
    <link rel="stylesheet/less" type="text/css" href="./less/product.less?v=Xko7ePekQEnwU4pJzf4il86jOuE8Rq1KMjVS-EeSgHc">
...
<body id="body">
    ...
    <header id="header" class="" style="background: #01815f;">

        <div id="div-parent-container-navigation" style="background:#003625">
            ...
            <div class="container position-relative container-nav" style="background:#003625;color:#fff">
                ...
                <nav id="navigation">
                    ...
                    <div class="position-relative">
                        ...
                        <ul id="nav" class="ul-navigation d-lg-flex d-none">
                            ...
                            <li class="nav-item">
                                <a class="nav-link external" href="https://perfumeara.com/mag/" target="_blank">رویداد ها</a>
                                <div class="underline-nav-item"></div>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="underline-nav-item d-lg-block d-none"></div>
                                <div class="dropdown-menu custom-dropdown">
                                    <a class="a_RedirectPersonel dropdown-item external" href="https://baharara.com/about.php?cat=PerfumeAra">درباره ما</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="underline-nav-item d-lg-block d-none"></div>
                                <div class="dropdown-menu custom-dropdown">
                                    <a class="a_RedirectPersonel dropdown-item external" href="emp" target="_blank">پرسنل</a>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link external" href="https://zarinp.al/perfumeara.com" target="_blank">تسویه حساب</a>
                                <div class="underline-nav-item"></div>
                            </li>
    ...
    <main id="main">
        ...
        <!--         <div class="container-logo container position-relative">
            <a href="/">
                <div class="div-parent-shape-logo-navigation">
                    ...
                    <img class="img-logo-navigation wow  flip slow animated" src="./img/logo_behara_nav.png"
                        style="visibility: visible; animation-name: flip;">
                </div>
            </a>
        </div> -->
        ...
        <main id="main">
                ...
                <div class="container container-content-header">
                    <div class="row m-0">
                        ...
                        <div class="col-12 div-col-title-white" style="z-index:2">
                            <h1 class="m-0" style="text-align: center; font-family: IS-M; color: #fff; font-size: 24px; line-height: 55px; text-shadow: 2px 2px 4px #000000;">
                                درباره ما</h1>
                        </div>
            ...
            <section id="section-related-product">
                <div class="container">
                    <div class="row" style="padding: 1rem; line-height: 2rem; margin-bottom: 1rem; text-align: justify;">
                        شرکت بهار آرا خراسان پس از سالها تجربه فعالیت و سرمایه گذاری موفق در صنعت عطر و ادکلن در سال ۱۳۹۳ با گردآوری تیمی متخصص و خبره در این حوزه تحقیقات خود را جهت ورود به این صنعت و با هدف تولید محصولات با کیفیت ، مطابق با استاندارد های جهانی در ایران آغاز بکار کرد و با چندین سال سابقه فعالیت ، عرضه کننده انواع محصولات به صورت مواد اولیه و محصولات نهایی در زمینه ادکلن ، ادوپرفیوم، بادی میست و... و همچنین واردات انواع اسانس های حلال در آب و حلال در الکل ، تولید بهترین شرکت های روز دنیا ، جهت مصارف ادکلن سازی ، خوشبو کننده بدن، محیط ، شوینده و پاک کننده و غیره می باشد.
                    </div>
                </div>
