...
$sql = "SELECT * FROM product WHERE main_cat = $id AND new_prod = 0 ORDER BY id DESC";
...
?>
                                    ...
                                    <div>
                                        <div class="div-title-content-details">
                                            <h2 style="color:#000000">محصولات جدید</h2>
                                            <hr>
                                        </div>
                                        <?php
require_once 'db.php';
...
$sql = "SELECT * FROM product WHERE main_cat=1 and new_prod =1 ORDER BY id DESC;";
$result = mysqli_query($conn, $sql);
$num = mysqli_num_rows($result);
...
for ($i = 0; $i < $num; $i++) {
    ...
    echo '
                                <div class="owl-item" style="width: 184px;">
                                <div id="chuckles_chips"' . $i . ' class="item item-parent-related-product">
                                    <a href="' . $url . '">
                                        <div class="item-related-product">
                                            <img src="' . $img . '">
                                            <div class="div-title-item-related-product">
