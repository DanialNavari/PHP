    ...
    <div class="top_part">
        <div class="person_info">
            <div class="person_logo">
                <img src="img/users/<?php echo $_COOKIE['uid']; ?>.jpg" alt="تصویر کاربر">
            </div>
            <?php $data = getUidInfo($_COOKIE['uid']);
            $name = $data['family'];
            $tel = $data['mtel']; ?>
            <div class="person_name"><? echo $name; ?></div>
            <div class="person_tel"><? echo $tel; ?></div>
        </div>
