...
function count_cat($uid, $zaman, $cat_id)
{
    ...
    db();
    $sql = "SELECT * FROM `cbd` WHERE `login` LIKE '%" . $zaman . "%' AND `uid` = '" . $uid . "' ORDER BY `id` ASC";
...
function payment_type_sep($payment_type = null, $pos = false)
{
    db();
    if ($pos) {
        $sqlc = "SELECT * FROM `payment` WHERE 1";
        $resc = mysqli_query($GLOBALS['conn'], $sqlc);
        $num = mysqli_num_rows($resc);
        for ($i = 0; $i < $num; $i++) {
            $rows = mysqli_fetch_assoc($resc);
                                ...
                                <h3 class="font-24 mb-1">گزارش روزانه مسیر :
                                    ...
                                    <div class="zaman">
                                        ...
                                        <table class="factor" style="text-align: center;margin-bottom:0.5rem;width: 100%;border: 2px solid #000;">
                                            ...
                                            <tr style="background-color: #f1f1f1;">
                                                <td colspan="18">نحوه تسویه</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3"><?php payment_type_sep($aa[1]['payment']); ?></td>
                                                <td colspan="3"><?php payment_type_sep($bb[2]['payment']); ?></td>
                                                <td colspan="3"><?php payment_type_sep($cc[3]['payment']); ?></td>
                                                <td colspan="3"><?php payment_type_sep($dd[4]['payment']); ?></td>
                                                <td colspan="3"><?php payment_type_sep($ee[5]['payment']); ?></td>
                                                <td colspan="3"><?php payment_type_sep($ff[6]['payment']); ?></td>

                                            </tr>
                                        </table>
                                        <table class="factor" style="text-align: center;margin-bottom:0.5rem;width: 100%;border: 2px solid #000;">
                                            <tr>
                                                <th colspan="18">فروش(ریال)</th>
                                            </tr>
                                            <tr style="background-color: #f1f1f1;">
                                                <?php get_parent(); ?>
                                            </tr>
                                            <tr>
                                                <td colspan="3"><?php echo $aa[1]['rial']; ?></td>
                                                <td colspan="3"><?php echo $bb[2]['rial']; ?></td>
                                                <td colspan="3"><?php echo $cc[3]['rial']; ?></td>
                                                <td colspan="3"><?php echo $dd[4]['rial']; ?></td>
                                                <td colspan="3"><?php echo $ee[5]['rial']; ?></td>
                                                <td colspan="3"><?php echo $ff[6]['rial']; ?></td>
                                            </tr>
                                            <tr style="background-color: #f1f1f1;">
                                                <td colspan="18">نحوه تسویه</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="5"><?php echo $aa[1]['p1'] + $bb[2]['p1'] + $cc[3]['p1'] + $dd[4]['p1'] + $ee[5]['p1'] + $ff[6]['p1']; ?></td>
                                                <td colspan="5"><?php echo $aa[1]['p2'] + $bb[2]['p2'] + $cc[3]['p2'] + $dd[4]['p2'] + $ee[5]['p2'] + $ff[6]['p2']; ?></td>
                                                <td colspan="5"><?php echo $aa[1]['p3'] + $bb[2]['p3'] + $cc[3]['p3'] + $dd[4]['p3'] + $ee[5]['p3'] + $ff[6]['p3']; ?></td>
                                                <td colspan="5"><?php echo $aa[1]['p4'] + $bb[2]['p4'] + $cc[3]['p4'] + $dd[4]['p4'] + $ee[5]['p4'] + $ff[6]['p4']; ?></td>
                                            </tr>
                                        </table>
                                        ...
                                        <table style="text-align: center;margin-bottom:0.5rem;width: 100%;border: 2px solid #000;">
                                            <tr>
                                                ...
                                                <td colspan="6">
                                                    <?php echo
                                                    $aa[1]['p1'] + $bb[2]['p1'] + $cc[3]['p1'] + $dd[4]['p1'] + $ee[5]['p1'] + $ff[6]['p1'] +
                                                        $aa[1]['p2'] + $bb[2]['p2'] + $cc[3]['p2'] + $dd[4]['p2'] + $ee[5]['p2'] + $ff[6]['p2'] +
                                                        $aa[1]['p3'] + $bb[2]['p3'] + $cc[3]['p3'] + $dd[4]['p3'] + $ee[5]['p3'] + $ff[6]['p3'] +
                                                        $aa[1]['p4'] + $bb[2]['p4'] + $cc[3]['p4'] + $dd[4]['p4'] + $ee[5]['p4'] + $ff[6]['p4'];
                                                    ?>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div class=" row" style="width: max-content; margin: 0 auto;">
                                        <form method="get" action="cbd.php" class="print">
                                            ...
                                            <button><a href="https://perfumeara.com/webapp/panel/visitors.php?g=<?php echo $_GET['g']; ?>" class="btn btn-danger">بازگشت</a></button>
