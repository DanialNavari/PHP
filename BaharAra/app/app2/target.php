...
$over_target = round(intval($target[100]) / intval($target[300] * 1000), 2) * 100;
?>
<div class="items">
    <fieldset class='hor' style="height: fit-content;">
        ...
        <table id="ttarget">
            <tr>
                ...
                <td class="t_left"><span id="resid"><?php echo sep3($target[200] * 1000); ?></span> تومان</td>
            </tr>
            <tr>
                <td class="t_right">محقق شده:</td>
                <td class="t_left"><span id="resid"><?php echo sep3($target[100]); ?></span> تومان</td>
            </tr>
            <tr>
