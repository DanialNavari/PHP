...
<table style="border: 1px solid silver; width: 97%;" id="ff">
    <tr style="border-bottom: 1px dashed gray;">
        <td>شماره فاکتور: </td>
        <td id="basket_id"><?php echo $info['id']; ?></td>
    </tr>
    <tr>
        <td>خریدار: </td>
        ...
        <td colspan="3">
            <select id="tasviye" class="form-control" onchange="tasviye_cal()">
                ...
                <optgroup label="__________________">
                    ...
                    <option value="400">خرید شخصی</option>
    ...
    <tr style="background: #009688;">
        ...
        <td style="border: 1px solid silver; padding: 0.2rem;" colspan="3" id="pay">
            <?php echo sep3($GLOBALS['sum_total']); ?> تومان
        </td>
    </tr>
</table>
