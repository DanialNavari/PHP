...
get_factor_store();
$tedad = count($nama_data);
?>

<div class=" items">
    <fieldset>
        <legend>لیست فاکتور های نمایندگان</legend>
        ...
        <table>
            ...
            <?php
            for ($i = 0; $i < $tedad; $i++) {
                $nama_factor = $nama_data[$i]['factor'];
                $nama_seller = $nama_data[$i]['seller'];
                $nama_name = $nama_data[$i]['namayande'];
                $nama_city = $nama_data[$i]['city'];
                $nama_driver = $nama_data[$i]['driver'];
                $nama_factor_id = $nama_data[$i]['factor_id'];

                echo "
                    <tr>
                        <td><a style='color: yellow;' href='https://perfumeara.com/webapp/app_new/panel/factor.php?f=$nama_factor_id&d=&store=ok' target='_blank'>$nama_factor</a></td>
                        <td>$nama_city</td>
                        <td>$jaam_kol عدد</td>
                        <td><button class='btn btn-success' style='font-size: 0.8rem; height: 2rem;'>ثبت</buttton></td>
                    </tr>
                    <tr>
                        <td colspan='5' style='text-align:right;font-size: 0.7rem;color:blanchedalmond'>نماینده: $nama_name</td>
                    </tr>
                    <tr>
                        <td colspan='5' style='text-align:right;font-size: 0.7rem;'>موزع: $nama_driver</td>
                    </tr>
                ";
            }
            ?>
