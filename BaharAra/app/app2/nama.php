<fieldset class='hor' style="height: inherit;" id="cdb_form">
    ...
    <span style="margin-top:1rem">نام نماینده / مسئول / منطقه را وارد کنید : </span>
    <br />
    <div>
    ...
    <div class="customer_info" style="display:none">
        ...
        <span>کدملی :</span>
        <div>
            <input type="text" id="codem" class="form-control" />
        </div>
        <span>تلفن :</span>
        <div>
...
<div class="order_pos">
    ...
    <div id="buy_pos">
        <button class="btn btn-warning" onclick="posit()">+</button>
        <button class="btn btn-warning" onclick="negit()">-</button><br />
    </div>
