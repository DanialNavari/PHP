...
<div class="cat">
    <div class="card my_card border_none" id="filters">
        <table class="table">
            <tr class="white">
                <td>
                    <a class="btn btn-warning w-100 fs-0-75 TalabK" style="padding:0.4rem" onclick="show_gharz('talabkari','TalabK')">طلب دارم</a>
                </td>
                <td>
                ...
                <td>
                    <a class="btn btn-prime w-100 fs-0-75 alLI" style="padding:0.4rem" onclick="show_gharz('all','alLI')">همه</a>
                </td>
            </tr>
        </table>
    </div>
