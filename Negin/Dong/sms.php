...
<div class="container">
    <div class="text-center mt-5 full_width px-2">
        ...
        <form action="#" class="form-inline mx-auto" id="sms">
            <input type="number" class="form-control text-center border_info rounded-lg" />
            <input type="number" class="form-control text-center border_info rounded-lg" />
            <input type="number" class="form-control text-center border_info rounded-lg" />
            <input type="number" class="form-control text-center border_info rounded-lg" />
            <input type="number" class="form-control text-center border_info rounded-lg" />
        ...
        <button class="btn btn_grad text-white mt-2 full_width rounded_7 btn_shadow">تایید کد</button>
    </div>
